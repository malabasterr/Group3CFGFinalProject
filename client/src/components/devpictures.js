      ...
      <div className="container">
        <div className="row">
          <div className="col-md-4">
            <div className=''>
            <img src={loginImage} alt="Maddy" className='dragonPic'/>
              <h6>1. Login</h6>
          ...
          <div className="col-md-4">
            <div className=''>
            <img src={greenDragon} alt="Kudzai" className='dragonPic'/>
          ...
          <div className="col-md-4">
            <div className=''>
            <img src={dragonLogo} alt="Niki" className='dragonPic'/>
              <h6>3. Quiz</h6>
            ...
            <div className="col-md-4">
            <div className=''>
            <img src={loginImage} alt="Eleri" className=''/>
              <h6>1. Login</h6>
              <p>Login to your personal account.</p>
